    ...
    <div className="admin-screen">
      ...
      <div className="safety-layout">
        <section className="instruction-ledger">
          <header><div><span className="admin-overline">ACTIVE INSTRUCTIONS · 03</span><h2>오늘 적용 지침</h2></div><button type="button">현장 알림 작성</button></header>
        ...
        <aside className="work-stop">
          ...
          <button onClick={() => setStopped((value) => !value)} type="button">{stopped ? '작업중지 해제' : '작업중지 발령'}</button>
